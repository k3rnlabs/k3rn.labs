...
export const MIRAVA_UNIVERSES: MiravaUniverse[] = [
  ...
  },
  {
    ...
    eyebrow: { fr: "LIFESTYLE · INOX · PRÉSENCE", es: "LIFESTYLE · ACERO · PRESENCIA" },
    tagline: { fr: "L’allure sportive et authentique du quotidien.", es: "El estilo deportivo y auténtico del día a día." },
    description: {
      fr: "Combinaison activewear mauve, cabas noir et miroir en acier inox : des instants créateur spontanés et crédibles, composés avec une finition éditoriale.",
      es: "Mono corto activewear morado, bolso negro y espejo de acero: momentos creativos espontáneos con un acabado editorial.",
    },
    image: "/visual-engine/univers/lifestyle-creatrice.png",
    keyElements: {
      fr: ["Combinaison activewear mauve", "Miroir inox contemporain", "Cabas de sport minimaliste", "Teint hâlé et attitude créatrice"],
      es: ["Mono corto activewear morado", "Espejo de acero contemporáneo", "Bolso de deporte minimalista", "Piel bronceada y actitud creadora"],
    },
    sampleBriefs: {
      fr: ["Un look lifestyle créatrice en combi mauve dans un ascenseur inox.", "Une matinée spontanée avant un tournage avec cabas noir et teint lumineux.", "Un selfie miroir tendance et naturel avant une journée active."],
      es: ["Un look lifestyle creadora con mono morado en un ascensor de acero.", "Una mañana espontánea con bolso negro y piel luminosa.", "Un selfie en espejo tendencia y natural antes de un día activo."],
    },
    creativeDirection: {
      location: { fr: "Ascenseur en acier inox ou studio contemporain", es: "Ascensor de acero inoxidable o estudio contemporáneo" },
      ...
      photoStyle: { fr: "Selfie miroir haute définition et lifestyle créatrice", es: "Selfie en espejo de alta definición y lifestyle creadora" },
      refinements: {
        locations: { fr: ["Ascenseur miroir inox", "Studio créateur contemporain", "Lobby d'hôtel moderne", "Suite urbaine"], es: ["Ascensor con espejo de acero", "Estudio creador contemporáneo", "Lobby de hotel moderno", "Suite urbana"] },
        stylings: { fr: ["Combi-short activewear mauve", "Tailoring décontracté", "Maille premium & cabas"], es: ["Mono corto activewear morado", "Sastrería relajada", "Punto premium y bolso"] },
        energies: { fr: ["Naturelle", "Active", "Spontanée"], es: ["Natural", "Activa", "Espontánea"] },
